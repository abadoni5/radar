...
const RadarCalculator: React.FC = () => {
  ...
  const calculate = () => {
    ...
    // Calculate Range (R)
    const R = Math.pow(
      (Pt * Math.pow(G, 2) * Ae * Sigma) / (Math.pow(4 * Math.PI, 2) * Pmin),
      1 / 4
    );
  ...
  return (
    <div className="flex justify-center items-center h-screen pt-64">
      <div className="max-w-4xl p-6 bg-gray-100 rounded-lg">
        <div className="grid grid-cols-2 gap-6">
          {/* Inputs for all parameters */}
          {/* Power Transmitted */}
          <div className="mb-4">
            <label htmlFor="pt" className="block text-gray-700 font-bold mb-2">
              Power Transmitted
            </label>
            <div className="flex">
              <input
        ...
        <div>
          ...
          <div>
            <label className="text-gray-700 font-bold">Range: </label>
            <input
              type="text"
              value={range || ""}
              disabled
          ...
          <div>
            <label className="text-gray-700 font-bold">Energy : </label>
            <input
              type="text"
              value={energy || ""}
              disabled
          ...
          <div>
            <label className="text-gray-700 font-bold">Hits Per Scan : </label>
            <input
              type="text"
              value={hitsPerScan || ""}
              disabled
          ...
          <div>
            <label className="text-gray-700 font-bold">Pulse Width : </label>
            <input
              type="text"
              value={pulseWidth || ""}
              disabled
